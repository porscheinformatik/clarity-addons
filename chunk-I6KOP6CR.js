import{a as J,b as K,c as Q}from"./chunk-PQUX3AWT.js";import"./chunk-S3DWPM3E.js";import{c as Z,d as G}from"./chunk-FIFVJXU5.js";import{Bk as Y,Xj as R,Yj as l,Zj as k,_j as F,ak as H}from"./chunk-YZEDXJUF.js";import{$a as O,Aa as T,Ba as M,Gb as V,H as B,I as w,Ia as _,Ja as z,Oa as c,Pa as n,Qa as t,Ra as E,Tb as j,_a as A,d as y,g as N,hf as U,hh as W,jb as $,lb as q,ma as d,nb as e,pb as I,ta as D,va as g,wa as P,wc as X}from"./chunk-S2BSNDU5.js";import"./chunk-76DGGKHL.js";var m=class extends R{id;constructor(p){super(),this.id=p}equals(p){return this.id===p.id}},x=class extends R{id;name;code;constructor(p,o,r){super(),this.id=p,this.name=o,this.code=r}equals(p){return this.id===p.id&&this.name===p.name&&this.code===p.code}};var L=(()=>{class a extends F{searchPerformed$=new y(1);constructor(){super()}getLazyChildren(o){return o.id.id==="lazy"?N([new l(new m("lazyChild"),"Lazy child")]):N([])}searchPerformed(o){this.searchPerformed$.next(o)}getSearchPerformed(){return this.searchPerformed$}static \u0275fac=function(r){return new(r||a)};static \u0275prov=B({token:a,factory:a.\u0275fac,providedIn:"root"})}return a})();var re=a=>({minCharacters:3,searchResultItemRef:a,placeholder:"My demo placeholder"});function ae(a,p){if(a&1&&(n(0,"span",16),e(1),t()),a&2){let o=O().$implicit;d(),I(" ",o.label)}}function le(a,p){if(a&1&&(e(0),_(1,ae,2,1,"span",16)),a&2){let o=p.$implicit;I(" ",o.name," "),d(),z(o.label?1:-1)}}var de=`
