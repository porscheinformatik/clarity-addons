  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./demos/view-edit-section/view-edit-section.demo.module').then(m => m.ViewEditSectionDemoModule),
        data: {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./demos/progress-spinner/progress-spinner.demo.module').then(m => m.ProgressSpinnerDemoModule),
        data: {
      ...
      },
      {
        path: 'letter-avatar',
        loadChildren: () =>
          import('./demos/letter-avatar/letter-avatar.demo.module').then(m => m.LetterAvatarDemoModule),
        data: {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./demos/multilingual-input/multilingual-input.demo.module').then(m => m.MultilingualInputDemoModule),
        data: {
      ...
      },
      {
        path: 'responsiveness',
        loadChildren: () =>
          import('./demos/responsiveness/responsiveness.demo.module').then(m => m.ResponsivenessDemoModule),
        data: {
