...
export class ClrSearchFieldValidators {
  /**
   * @description
   ...
   *
   * ```typescript
   * const control = new FormControl(2, ClrSearchFieldValidators.min(3, '.', ','));
   *
   ...
   *
   * ```typescript
   * const control = new FormControl(16, ClrSearchFieldValidators.max(15, '.', ','));
   *
