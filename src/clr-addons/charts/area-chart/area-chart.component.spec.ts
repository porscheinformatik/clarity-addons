...
const SINGLE_SERIES: AreaChartSeries[] = [
  {
    key: 'revenue',
    label: 'Revenue',
    color: '#e57200',
...
const MULTI_SERIES: AreaChartSeries[] = [
  ...SINGLE_SERIES,
...
describe('AreaChartComponent', () => {
  ...
  let componentRef: ComponentRef<AreaChartComponent>;
  ...
  describe('inputs – defaults', () => {
    ...
    it('should default areaOpacity to 0.2', () => expect(component.areaOpacity()).toBe(0.2));
    it('should default exportFilename to "area-chart"', () => expect(component.exportFilename()).toBe('area-chart'));
  ...
  describe('alertMessageAndType()', () => {
    ...
    it('should return no-items alert when series data arrays are empty', () => {
  ...
  describe('exportFilename input', () => {
    it('should accept a custom exportFilename', () => {
      componentRef.setInput('exportFilename', 'my-area');
      expect(component.exportFilename()).toBe('my-area');
    });
  });
