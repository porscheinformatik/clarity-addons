...
describe('GroupedBarChartComponent', () => {
  ...
  describe('inputs – defaults', () => {
    ...
    it('should default showValues to false', () => expect(component.showValues()).toBeFalse());
  ...
  describe('showValues input', () => {
    it('should accept showValues', () => {
      componentRef.setInput('showValues', true);
      fixture.detectChanges();
      expect(component.showValues()).toBeTrue();
    });
  });

  describe('yAxisLabelWidthPx input', () => {
    it('should accept a custom y-axis label width', () => {
      componentRef.setInput('yAxisLabelWidthPx', 140);
      fixture.detectChanges();
      expect(component.yAxisLabelWidthPx()).toBe(140);
    });
  });
