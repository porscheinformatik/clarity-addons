import{a as J,b as K,c as Q}from"./chunk-7JWTSFMQ.js";import"./chunk-ZF3MJ7PP.js";import{c as Z,d as G}from"./chunk-WTBP7HS6.js";import{$j as F,Fk as Y,Yj as R,Zj as l,_j as k,bk as H}from"./chunk-DAEFJAFC.js";import{$a as O,Aa as M,G as B,Gb as V,H as w,Ha as _,Ia as z,Na as c,Oa as n,Pa as t,Qa as E,Tb as j,Za as A,d as y,g as N,jb as $,jf as U,la as d,lb as q,lh as W,nb as e,pb as I,sa as D,ua as g,va as P,wc as X,za as T}from"./chunk-VRBOT7LG.js";import"./chunk-76DGGKHL.js";var m=class extends R{id;constructor(p){super(),this.id=p}equals(p){return this.id===p.id}},x=class extends R{id;name;code;constructor(p,o,r){super(),this.id=p,this.name=o,this.code=r}equals(p){return this.id===p.id&&this.name===p.name&&this.code===p.code}};var L=(()=>{class a extends F{searchPerformed$=new y(1);constructor(){super()}getLazyChildren(o){return o.id.id==="lazy"?N([new l(new m("lazyChild"),"Lazy child")]):N([])}searchPerformed(o){this.searchPerformed$.next(o)}getSearchPerformed(){return this.searchPerformed$}static \u0275fac=function(r){return new(r||a)};static \u0275prov=B({token:a,factory:a.\u0275fac,providedIn:"root"})}return a})();var re=a=>({minCharacters:3,searchResultItemRef:a,placeholder:"My demo placeholder"});function ae(a,p){if(a&1&&(n(0,"span",16),e(1),t()),a&2){let o=O().$implicit;d(),I(" ",o.label)}}function le(a,p){if(a&1&&(e(0),_(1,ae,2,1,"span",16)),a&2){let o=p.$implicit;I(" ",o.name," "),d(),z(o.label?1:-1)}}var de=`
