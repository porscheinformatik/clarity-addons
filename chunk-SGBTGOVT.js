import{a as J,b as K,c as Q}from"./chunk-ZWOZOTSY.js";import"./chunk-53GF5SVT.js";import{c as Z,d as G}from"./chunk-DN6L23IV.js";import{Uj as v,Vj as l,Wj as k,Xj as F,Zj as H,yk as Y}from"./chunk-YDQMSJCF.js";import{Aa as M,Cb as V,Fa as _,Ga as z,I as B,J as w,La as c,Ma as n,Na as t,Oa as S,Qb as j,Qe as U,Qg as W,Xa as A,Ya as O,d as y,gb as $,h as I,ib as q,kb as e,mb as N,na as d,ta as D,tc as X,va as g,wa as P,za as T}from"./chunk-MAQU7QF7.js";import"./chunk-UKNGC2Y4.js";var s=class extends v{id;constructor(h){super(),this.id=h}equals(h){return this.id===h.id}},u=class extends v{id;name;code;constructor(h,i,r){super(),this.id=h,this.name=i,this.code=r}equals(h){return this.id===h.id&&this.name===h.name&&this.code===h.code}};var L=(()=>{class a extends F{searchPerformed$=new y(1);constructor(){super()}getLazyChildren(i){return i.id.id==="lazy"?I([new l(new s("lazyChild"),"Lazy child")]):I([])}searchPerformed(i){this.searchPerformed$.next(i)}getSearchPerformed(){return this.searchPerformed$}static \u0275fac=function(r){return new(r||a)};static \u0275prov=B({token:a,factory:a.\u0275fac,providedIn:"root"})}return a})();var re=a=>({minCharacters:3,searchResultItemRef:a,placeholder:"My demo placeholder"});function ae(a,h){if(a&1&&(n(0,"span",16),e(1),t()),a&2){let i=O().$implicit;d(),N(" ",i.label)}}function le(a,h){if(a&1&&(e(0),_(1,ae,2,1,"span",16)),a&2){let i=h.$implicit;N(" ",i.name," "),d(),z(i.label?1:-1)}}var de=`
