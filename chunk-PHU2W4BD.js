import{a as J,b as K,c as Q}from"./chunk-2WGLSRRL.js";import"./chunk-S3DWPM3E.js";import{c as Z,d as G}from"./chunk-NBDQID2S.js";import{$j as H,Ak as Y,Wj as R,Xj as l,Yj as k,Zj as F}from"./chunk-2NDUSNGF.js";import{Ba as T,Ca as M,Eb as V,Ha as _,Ia as z,J as B,K as w,Na as c,Oa as n,Pa as t,Qa as E,Sb as j,Za as A,_a as O,d as y,h as N,hf as U,hh as W,ib as $,kb as q,mb as e,oa as d,ob as I,ua as D,wa as g,wc as X,xa as P}from"./chunk-4CQQLUFG.js";import"./chunk-76DGGKHL.js";var m=class extends R{id;constructor(p){super(),this.id=p}equals(p){return this.id===p.id}},x=class extends R{id;name;code;constructor(p,o,r){super(),this.id=p,this.name=o,this.code=r}equals(p){return this.id===p.id&&this.name===p.name&&this.code===p.code}};var L=(()=>{class a extends F{searchPerformed$=new y(1);constructor(){super()}getLazyChildren(o){return o.id.id==="lazy"?N([new l(new m("lazyChild"),"Lazy child")]):N([])}searchPerformed(o){this.searchPerformed$.next(o)}getSearchPerformed(){return this.searchPerformed$}static \u0275fac=function(r){return new(r||a)};static \u0275prov=B({token:a,factory:a.\u0275fac,providedIn:"root"})}return a})();var re=a=>({minCharacters:3,searchResultItemRef:a,placeholder:"My demo placeholder"});function ae(a,p){if(a&1&&(n(0,"span",16),e(1),t()),a&2){let o=O().$implicit;d(),I(" ",o.label)}}function le(a,p){if(a&1&&(e(0),_(1,ae,2,1,"span",16)),a&2){let o=p.$implicit;I(" ",o.name," "),d(),z(o.label?1:-1)}}var de=`
